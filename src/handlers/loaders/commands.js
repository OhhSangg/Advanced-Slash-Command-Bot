...
module.exports = (client) => {
    ...
    const rest = new REST({ version: '9' }).setToken("OTAwNjAxMjM4NzQyMjQ5NDgz.GKZEsN.g7iGXnjn0SqkZj7KU_ZW9ne6ZVOP0hzvCu8pNo");
    ...
    (async () => {
        try {
            ...
            await rest.put(
                Routes.applicationCommands("900601238742249483"),
                { body: commands },
            )
