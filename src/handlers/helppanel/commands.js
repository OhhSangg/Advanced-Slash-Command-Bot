...
module.exports = async (client) => {
    const fields = [
        ...
        {
            name: `<:minecraft:989774527720468510> ┆ Minecraft`,
            ...
            if (interaction.values == "commands-Bothelp") {
                ...
                const row = new Discord.MessageActionRow()
                    .addComponents(
                        ...
                        new Discord.MessageButton()
                            .setLabel("Invite")
                            .setURL("https://discord.com/oauth2/authorize?&client_id=900601238742249483&scope=applications.commands+bot&permissions=8")
                            .setStyle("LINK"),
                ...
                client.embed({
                    title: `❓・Help panel`,
                    desc: `View all command categories in the bot here! \n\n[Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/900601238742249483/vote) `,
