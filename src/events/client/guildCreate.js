...
.setThumbnail("https://cdn.discordapp.com/attachments/843487478881976381/852419422392156210/BotPartyEmote.png")
        ...
        client.embed({
            ...
            fields: [{
                name: "📢┆Alert!",
                value: 'After more than 1 year we decided to stop Bot on April 15th, for more information go to [support server](https://discord.gg/xAWGYeh2TU)',
                inline: false,
            },
            {
                name: "❓┆How to setup?",
            ...
            },
            {
                ...
                value: `You can DM <@700410464919879782> for support or joining the [[Support server]](${client.config.discord.serverInvite})`,
                inline: false,
            },
            {
